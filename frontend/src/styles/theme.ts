export const theme = {
  ...
  components: {
    ...
    input: 'block w-full px-4 py-3 bg-white border border-neutral-border rounded-xl text-neutral-primary text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary/20 focus:border-brand-primary transition-all font-sans',
    inputMono: 'block w-full px-4 py-3 bg-white border border-neutral-border rounded-xl text-neutral-primary text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary/20 focus:border-brand-primary transition-all font-mono',
    ...
    buttonSecondary: 'w-full flex items-center justify-center gap-1.5 py-3 px-4 bg-brand-lavender text-brand-primary hover:bg-brand-primary/10 rounded-xl text-sm font-semibold transition-all duration-150 active:scale-[0.98] disabled:opacity-50 cursor-pointer disabled:bg-neutral-border/40 disabled:text-neutral-secondary',
  },
